...
@section("content")
    <div class="container">
        <h2>Role List</h2>
        {{-- <a href="{{ route("web-mroles.create") }}" class="btn btn-primary mb-3">Add New Role</a> --}}
                    ...
                    .then(response => {
                        ...
                        response.data.content.forEach(role => {
                            ...
                            row.innerHTML = `
                                                ...
                                                <td>${role.level}</td>
                                                <td>
                                                    <a href="/web/m-role/detail/${role.id}" class="btn btn-sm btn-info">Detail</a>
                                                    <a href="/web/m-role/edit/${role.id}" class="btn btn-sm btn-info">Edit</a>
                ...
                columns: [
                    ...
                    { data: "level" },
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            const detailUrl = `/web/m-role/detail/${row.id}`;
                            const editUrl = `/web/m-role/edit/${row.id}`;
